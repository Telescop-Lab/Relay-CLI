...
export function createRootCommand(version: string) {
  ...
  program.addHelpText(
    ...
    [
      ...
      '  logout',
      '  whoami',
      '  devices list/add/rename/revoke',
      '  ws list/use/create/info/rename/delete',
      '  ws message show/set',
      '  folder list/create/rename/move/delete',
      '  bundle inbox/list/show/pull/push/edit/restore/delete',
      '  history',
      '  storage stats',
      '  tools schema',
      '  export',
